...
impl_deserialize!(Welcome, "Welcome", WelcomePayload, SessionWelcome);
...
impl_deserialize!(Reconnect, "Reconnect", ReconnectPayload, SessionReconnect);
impl_deserialize!(Revocation, "Revocation", RevocationPayload, Revocation);
